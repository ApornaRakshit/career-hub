        ...
        <div className="">
            <div className="card card-side bg-base-100 mx-10 my-10 shadow-xl ">
                <div className="card-body w-full gap-4">
                    ...
                    <p><span className="font-semibold">Job Responsibility:</span>{Responsibility}</p>
                    <p><span className="font-semibold">Educational Requirements:</span>{requirements}</p>
                    <p><span className="font-semibold">Experiences:</span>{experience}</p>
                </div>
            </div>
            <div className="card card-side bg-base-100 mx-10 my-10 shadow-xl ">
